    ...
    public class MDM_TunnelCreatorEditorWindow : EditorWindow
    {
        ...
        private void OnSceneGUI()
        {
            ...
            for (int i = iFrom + 1; i <= iTo; i++)
            {
                ...
                Handles.SphereHandleCap(0, tc.tNodes[i].transform.position + referen.right * currentTheta, Quaternion.LookRotation(tc.tNodes[i].position - tc.tNodes[i - 1].position), 0.5f, EventType.Layout);
            }
        }
